...
| [CVE-2018-20796](https://www.suse.com/security/cve/CVE-2018-20796.html) | In the GNU C Library (aka glibc or libc6) through 2.29, check_dst_limits_calc_pos_1 in posix/regexec.c has Uncontrolled Recursion. | 26 Feb 2019 | NeuVector flagged this in 5.4.x (NVSHAS-9930) as a **false positive** detection on the `glibc/libc-bin` package. |

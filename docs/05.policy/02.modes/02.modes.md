...
To block traffic in case of network violation, Neuvector enforcers are put inline of network connections, there are two ways of putting enforcer inline.

+ **Veth bridge**
> If container's interfaces are of Veth type.
+ **Netfilter_queue**
> If not all of container's interfaces are of Veth type, multus CNI falls into this case.

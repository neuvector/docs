...
Federation policy can only be imported on a primary cluster. After import, the primary cluster deploys the policies to all managed clusters.

Here is an example for exporting a federated group:

...
* [Removal of hard-coded encryption key](https://github.com/neuvector/neuvector/security/advisories/xxxx)
* [Enforce TLS verification for requests to Telemetry server](https://github.com/neuvector/neuvector/security/advisories/xxxx)
* [Check consul ports for enforcer](https://github.com/neuvector/neuvector/security/advisories/xxxx)

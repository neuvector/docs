...
Refer to the [Security Advisory and CVEs](../../16.security_advisories/01.security_advisories/cve.md) documentation for more information.
...
For more information, refer to [Security Advisories and CVEs](../../16.security_advisories/01.security_advisories/cve.md)

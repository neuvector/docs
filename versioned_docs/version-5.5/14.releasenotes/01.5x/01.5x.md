...
##### Bugs fixed
* [#2227](https://github.com/neuvector/neuvector/issues/2227): UBI controller images don't work in newer OpenShift environment
...
Refer to the [Security Advisory and CVEs](versioned_docs/version-5.5/cve.md) documentation for more information.
...
For more information, refer to [Security Advisories and CVEs](versioned_docs/version-5.5/cve.md)

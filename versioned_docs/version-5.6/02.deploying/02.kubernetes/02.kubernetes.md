...
:::warning attention
The repo used in this deployment guide (https://raw.githubusercontent.com/neuvector/manifests/) has been deprecated. Please use neuvector HELM to create manifest for deploying neuvector components.

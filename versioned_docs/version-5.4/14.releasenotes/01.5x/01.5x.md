...
The following steps are needed only for the deployments that used yaml file. Upgrading using helm doest not need these steps because internal certificates are created by these flags by default `internal.autoGenerateCert` and `internal.autoRotateCert` by helm. 
...
Additional info about internal certificates
*https://github.com/neuvector/docs/blob/main/versioned_docs/version-5.4/02.deploying/01.production/04.internal/04.internal.md*

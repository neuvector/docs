...
(2) Its recommnded to set system-trusted (de-facto) namespaces (system and network-plugin) as BASIC protection. For example, "kube-system", "ovn-*" etc. and set other application pods as Zero Drift 
:::

...
In Risk Reports page, when secrets are detected, the alert format will be like the picture below.

Note: It will show info like "${variable}=${value}". Ex: in the picture below, it will show "env1=AIDAJQ..."

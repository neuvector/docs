...
The following sample YAML is for version 5.4.2 onwards where we need to mount the internal certificates on Controller, Enforcer and scanner pods since we dont support hardcoded certificates anymore. Steps to create self-signed certificate can be found here https://open-docs.neuvector.com/deploying/production/internal

...
If using YAML deployment, please add the "podLabels" on the enforcer YAML configuration. Also podLabels and resources as shown in the above example for scanner YAML configuration.

...
```yaml
vjayagopal@cloudshell:~ (ei-container-security)$ kubectl get AllowlistSynchronizer neuvector-allowlist -o yaml
apiVersion: auto.gke.io/v1
kind: AllowlistSynchronizer
metadata:
  annotations:
  ...
  creationTimestamp: "2025-04-22T20:11:40Z"
  generation: 1
  name: neuvector-allowlist
  resourceVersion: "8613"
  uid: 7ed48527-a681-4967-83f0-17327e53c2bc
spec:
  allowlistPaths:
  - SUSE/neuvector-enforcer/v1.0.0/suse-neuvector-enforcer.yaml
  - SUSE/neuvector-scanner/v1.0.0/suse-neuvector-scanner.yaml
status:
  conditions:
  - lastTransitionTime: "2025-04-22T20:11:41Z"
    message: 'some allowlist paths failed to sync: path SUSE/neuvector-enforcer/v1.0.0/suse-neuvector-enforcer.yaml
      not found, path SUSE/neuvector-scanner/v1.0.0/suse-neuvector-scanner.yaml not
      found'
    observedGeneration: 1
    reason: SyncError
    status: "False"
    type: Ready
  lastSyncAttempt: "2025-04-22T20:11:41Z"
```

Now, you can use HELM or YAML for deploying NeuVector on GKE Autopilot cluster. To learn more about allowlistSynchronizer please visit this GKE documentation. https://cloud.google.com/kubernetes-engine/docs/how-to/run-autopilot-partner-workloads

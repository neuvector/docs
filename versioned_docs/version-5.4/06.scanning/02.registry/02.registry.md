...
NeuVector now supports image scanning from [GitHub Container Registry (GHCR)](https://ghcr.io), enabling users to include images stored in GitHub in their security and compliance workflows.

##### Add GitHub Container Registry

To configure GHCR in NeuVector, go to **Add Registry** and select **GitHub Container Registry** from the registry type dropdown.

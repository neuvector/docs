...
* Officially supported container management systems, Kubernetes, native docker, docker swarm, docker UCP/DataCenter, docker Cloud, Rancher, Google GKE/Kubernetes,  Amazon AWS ECS/EKS, Microsoft Azure AKS, VMware Photon, RedHat OpenShift 3.x,4.x, IBM IKS, SUSE CaaS, Mirantis Kubernetes Engine.

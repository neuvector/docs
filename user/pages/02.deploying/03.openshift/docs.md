...
<!-- NOTE: Toggle Box #0.5 -->
  ...
  <label class="title-panel" onClick="" for="acccrd"><span><i class="icon-code"></i>View  NeuVector CRD yaml for OpenShift 4.6+ (K8s 1.19+)</span></label>
...
```
oc apply -f https://raw.githubusercontent.com/neuvector/manifests/main/kubernetes/crd-k8s-1.16.yaml
```
<html>
<head>
<link rel="stylesheet" href="/serverless/toggle-box.css" type="text/css" />
...
<!-- NOTE: Toggle Box #0.7 -->
  ...
  <label class="title-panel" onClick="" for="acccrd2"><span><i class="icon-code"></i>View  NeuVector CRD yaml for OpensShift 4.5 and earlier (K8s 1.18 and earlier)</span></label>
  <!-- NOTE: Toggle box content animation option -->
  <div class="accordion-content animated animation5">
  <div class="wrap-content">
<pre>

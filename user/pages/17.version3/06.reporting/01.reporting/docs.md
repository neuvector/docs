...
### Reporting 
Reports can be viewed and downloaded from several menus in the NeuVector console. The Dashboard displays a security summary which can be downloaded as a pdf.
...
![Reports](security_risks_reports.png)

Please see the Event Limits note below limitations of event reporting.
...
This is why once the limit is reached, only the most recent 4K events of that type are shown. This affects the Notications lists are well as the displays in the Dashboard.
